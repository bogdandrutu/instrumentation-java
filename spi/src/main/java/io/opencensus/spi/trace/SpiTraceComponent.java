 ...
 * @since 0.5
 */
public abstract class SpiTraceComponent {
  /**
   ...
   */
  static SpiTraceComponent newNoopTraceComponent() {
    return new NoopSpiTraceComponent();
  }

  private static final class NoopSpiTraceComponent extends SpiTraceComponent {
