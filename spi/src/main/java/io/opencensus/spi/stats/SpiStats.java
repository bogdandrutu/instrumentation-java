...
/**
 * Class for accessing the default {@link SpiStatsComponent}.
 *
 * @since 0.8
 */
public final class SpiStats {
  private static final Logger logger = Logger.getLogger(SpiStats.class.getName());

  private static final SpiStatsComponent statsComponent =
      loadStatsComponent(SpiStatsComponent.class.getClassLoader());
  ...
  public static ViewManager getViewManager() {
    return statsComponent.getExportComponent().getViewManager();
  }
  ...
  static SpiStatsComponent loadStatsComponent(@Nullable ClassLoader classLoader) {
    try {
      // Call Class.forName with literal string name of the class to help shading tools.
      return Provider.createInstance(
          Class.forName(
              "io.opencensus.impl.stats.SpiStatsComponentImpl", /*initialize=*/ true, classLoader),
          SpiStatsComponent.class);
    ...
    try {
      ...
      return Provider.createInstance(
          Class.forName(
              "io.opencensus.impllite.stats.SpiStatsComponentImplLite",
              /*initialize=*/ true,
              classLoader),
          SpiStatsComponent.class);
    } catch (ClassNotFoundException e) {
    ...
    return SpiStatsComponent.newNoopSpiStatsComponent();
  }
